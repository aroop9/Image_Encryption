...
# save button created
saveb = Button(window, text="Save",command=save_img,font=("Franklin Gothic Heavy", 15), bg = "yellow", fg = "white", borderwidth=3, relief="raised")
